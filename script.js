...
$('#QuickReply').find('.submitUnit').children('input').eq(1).after('<a type="button" class="button primary boutonMessage" data-msg="Salut,<br><br>Il est illégal de [B][COLOR=rgb(0,102,102)]vendre des comptes[/COLOR][/B] sur [COLOR=rgb(0,102,102)][B]RealityGaming[/B][/COLOR].<br>">Comptes</a>');
